...
XBMCKey CControllerTranslator::TranslateKeysym(const std::string &symbol)
{
  ...
  if (symbol == "return") return XBMCK_RETURN;
  ...
  if (symbol == "scrollock") return XBMCK_SCROLLOCK;
  ...
  if (symbol == "print") return XBMCK_PRINT;
...
const char *CControllerTranslator::TranslateKeycode(XBMCKey keycode)
{
  switch (keycode)
  {
    ...
    case XBMCK_RETURN: return "return";
    ...
    case XBMCK_SCROLLOCK: return "scrollock";
